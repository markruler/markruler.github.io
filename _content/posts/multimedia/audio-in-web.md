...
주요 오디오 포맷의 특성과 브라우저 호환성,
[Web Audio API](https://developer.mozilla.org/en-US/docs/Web/API/Web_Audio_API)를 통한 **실시간 처리**와
[MediaStream Recording API](https://developer.mozilla.org/en-US/docs/Web/API/MediaStream_Recording_API)를 통한
**녹음(Recording)**, 그리고 **브라우저 정책**까지 다뤄보겠습니다.
...
FLAC도 오픈 소스이며 `.flac` 자체의 컨테이너를 사용하거나, Ogg 컨테이너에 담아 `.ogg`로 쓸 수도 있습니다.
